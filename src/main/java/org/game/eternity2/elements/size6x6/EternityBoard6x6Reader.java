...
/**
 * A way to read a (possibly partial) solution to the Eternity II box set from a
 * file.
 *
...
public class EternityBoard6x6Reader extends AbstractEternityBoardReader {
    ...
    public final static EternityBoard6x6 hintEternityBoard6x6 = new EternityBoard6x6Reader(DEFAULT_PATH_HINTS_6x6)
            .getBoard();

    public final static EternityBoard6x6 piecesEternityBoard6x6 = new EternityBoard6x6Reader(DEFAULT_PATH_PIECES_6x6)
            .getBoard();

    public final static EternityBoard6x6 solvedEternityBoard6x6 = new EternityBoard6x6Reader(DEFAULT_PATH_SOLVED_6x6)
            .getBoard();
    ...
    public final @NotNull EternityBoard6x6 getBoard() {
        ...
        for (EternityXMLTile currentEternityXMLTile : eternityXMLTiles) {
            ...
            EternityTile6x6 eternityTile6x6 = (EternityTile6x6) EternityTiles6x6.TILESSTORE.getTileAt(tileNumber % 6,
                    tileNumber / 6);
            if (number > 0 && number < 37) {
                if (!checkedTiles[tileNumber]) {
                            ...
                            if ((yPosition > -1) && (yPosition < 6)) {
                                if (eternityBoard.isTileFree(xPosition, yPosition)) {
                                    ...
                                    throw new IllegalArgumentException(
                                            "Coordinate Y must be between 0 and getYBoardSize().");
                            } else
                                throw new IllegalArgumentException(
                                        "Coordinate X must be between 0 and getXBoardSize().");
                        } else
                    ...
                    throw new IllegalArgumentException("Back value must be an integer between 1 and 36.");
            }
        }
