...
public final class EternityBasicPatterns16x16 extends AbstractEternityBasicPatterns {
    ...
    public static EternityBasicPattern16x16 getPatternFromInteger(int value) {
        switch (value) {
            case 0 -> {
            ...
            case 3 -> {
                return EternityBasicPatternBrownGreen;
            }
            case 4 -> {
                return EternityBasicPatternLightBlueRose2;
            }
            case 5 -> {
            ...
            case 7 -> {
                return EternityBasicPatternLightBlueRose;
            }
            case 8 -> {
                return EternityBasicPatternDarkBlueOrange;
            }
            case 9 -> {
            ...
            case 11 -> {
                return EternityBasicPatternGreenOrange;
            }
            case 12 -> {
                return EternityBasicPatternYellowDarkBlue;
            }
            case 13 -> {
                return EternityBasicPatternBrownOrange;
            }
            case 14 -> {
                return EternityBasicPatternGreenRose;
            }
            case 15 -> {
                return EternityBasicPatternYellowGreen;
            }
            case 16 -> {
                return EternityBasicPatternDarkBlueLightBlue;
            }
            case 17 -> {
            ...
            case 19 -> {
                return EternityBasicPatternBrownYellow;
            }
            case 20 -> {
                return EternityBasicPatternOrangePurple;
            }
            case 21 -> {
                return EternityBasicPatternRoseYellow;
            }
            case 22 -> {
                return EternityBasicPatternDarkBlueRose;
            }
