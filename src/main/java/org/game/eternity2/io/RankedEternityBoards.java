...
/**
 * The score board of best solutions so far. Use with a database to output
 * statistics, currently in a flat file.
 *
 * This is done the old way but may be it would be better with FileChannel :
 * https://stackoverflow.com/questions/22929248/how-to-use-filechannel-as-argument-to-write-object
 * or not
 * https://codereview.stackexchange.com/questions/76877/reading-and-writing-serializable-objects-using-nio
 *
 * Eventually, we could switch to something like
 * https://github.com/nitrite/nitrite-java or perhaps
...
public class RankedEternityBoards {
    ...
    public static void writeToFile(@NotNull String path, @NotNull List<RankedEternityBoard> rankedBoards)
            throws IOException {
    ...
    public static void readFromFile(@NotNull String path, @NotNull List<RankedEternityBoard> rankedBoards)
            throws IOException {
