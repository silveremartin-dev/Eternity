...
public class EternityUser {
    ...
    public void setComputedTime(@NotNull Duration computedTime) {
        ...
        } else throw new IllegalArgumentException("You cannot set a null computed time.");
    }
    ...
    public void setComputedPackets(@NotNull List<EternityPacket> computedPackets) {
        ...
        } else throw new IllegalArgumentException("You cannot set a null computed packets array.");
    }
    ...
    public void setComputedTiles(@NotNull List<EternityTileInterface> computedTiles) {
        ...
        } else throw new IllegalArgumentException("You cannot set a null computed tiles array.");
    }
    ...
    public void setBestScores(@NotNull List<Integer> bestScores) {
        ...
        } else throw new IllegalArgumentException("You cannot set a null best scores array.");
    }
    ...
    public void setBestSolutions(@NotNull List<EternityBoardInterface> bestSolutions) {
        ...
        } else throw new IllegalArgumentException("You cannot set a null best solutions array.");
    }
